...
def takeScreenshot(packet):
    ...
    if after_count == before_count + 1:
        packet = RoveCommPacket(manifest["Camera2"]["Telemetry"]["PictureTaken2"]["dataId"], "B", (1,))
        rovecomm_node.write(packet, False)


def main():
    rovecomm_node.set_callback(manifest["Camera2"]["Commands"]["TakePicture"]["dataId"], takeScreenshot)
    while True:
        pass
